...
| T2.4 | #7    |                 Domain — Product + Stock: UseCases e Services |         4h | Média      | ✅ Concluído    | [#7](https://github.com/Vandrs/common-cornershop/issues/7) |
...
> Nota: T2.4 concluído na branch `feat/T2.4-product-stock-usecases`.
